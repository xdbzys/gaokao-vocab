...
const numberDateData = {
  months: [
    ...
    { word: 'February', phonetic: '/ˈfebrueri/', cn: '二月', abbr: 'Feb.', examples: ['February has 28 or 29 days.|||二月有28天或29天。', 'Valentine\'s Day is in February.'] },
    { word: 'March', phonetic: '/mɑːrtʃ/', cn: '三月', abbr: 'Mar.', examples: ['March is the beginning of spring.|||三月是春天的开始。', 'Women\'s Day is on March 8th.'] },
    ...
    { word: 'June', phonetic: '/dʒuːn/', cn: '六月', abbr: 'Jun.', examples: ['Children\'s Day is in June.', 'Summer begins in June.|||夏天从六月开始。'] },
  ...
  dateWords: [
    { word: 'today', phonetic: '/təˈdeɪ/', cn: '今天', examples: ['What day is it today?', 'Today is Monday.|||今天是星期一。'] },
