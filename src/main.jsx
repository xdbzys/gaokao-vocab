...
const seedWords985 = [
  ...
  ['comb', 'n.', '梳子，vt.梳理', '985', ['梳子，vt.梳理'], ['梳子，vt.梳理'], ['The interview covered several topics related to comb.|||采访涵盖了与梳子相关的几个主题。']],
  ...
  ['file', 'n.', '文件，档案，文件夹，vt.把…归档', '985', ['文件，档案，文件夹v'], ['文件，档案，文件夹，vt.把…归档'], ['The interview covered several topics related to file.|||面试涵盖了与文件相关的几个主题。']],
  ...
  ['puzzle', 'n.', '难题;谜，vi.使迷惑', '985', ['难题;谜，vi.使迷惑'], ['难题;谜，vi.使迷惑'], ['The interview covered several topics related to puzzle.|||采访涵盖了与拼图相关的几个主题。']],
  ...
  ['shade', 'n.', '树荫，阴影，阴凉处，遮光物，vi.荫蔽', '985', ['树荫，阴影，阴凉处，'], ['树荫，阴影，阴凉处，遮光物，vi.荫蔽'], ['The interview covered several topics related to shade.|||采访涵盖了与阴影相关的几个主题。']],
      ...
      {section === 'extend' && (
        <section className="panel">
          <div className="segmented">
            ...
            <button className={extendTab === 'confusing' ? 'active' : ''} onClick={() => setExtendTab('confusing')}>易混词</button>
          ...
          {extendTab === 'confusing' && (() => {
            ...
            for (const entry of confusingWordsData) {
              for (const target of entry.confuses) {
                ...
                // 只显示词库中存在的词
                const wordItem = allWords.find(w => w.term.toLowerCase() === entry.word);
            ...
            return (
            <div>
              <p className="muted" style={{ marginBottom: 12 }}>以下单词拼写相似但含义完全不同，高考常考辨析。点击单词可查看详情。</p>
              <div className="list">
                {pairs.map((pair, i) => (
                  <article key={i} className="listItem confusingPairItem">
                    <div className="confusingPairWords">
                      <span
                        className="confusingWordTag"
                        style={{ cursor: pair.item1 ? 'pointer' : 'default', color: pair.item1 ? '#2563eb' : 'var(--text-tertiary)' }}
                        onClick={() => pair.item1 && setDetailItem(pair.item1)}
                      >
                        {pair.word1}
                      </span>
                      <span className="confusingVs">vs</span>
                      <span
                        className="confusingWordTag"
                        style={{ cursor: pair.item2 ? 'pointer' : 'default', color: pair.item2 ? '#dc2626' : 'var(--text-tertiary)' }}
                        onClick={() => pair.item2 && setDetailItem(pair.item2)}
                      >
                        {pair.word2}
                      </span>
